T = readtable("data_single_cases_analysis/smbt11950smbtf2300smb00.3smb10.15smbf0.0sillmin415sillmax425sillslope0.01hnd2.18lnd4.44bx-0.001_fixed_obs.csv");
...
OBS = readtable("data_single_cases_analysis/obs_smbt11950smbtf2300smb00.3smb10.15smbf0.0sillmin415sillmax425sillslope0.01hnd2.18lnd4.44bx-0.001_fixed_obs.csv");
t0 = table2array(T(:,"t"));
...
legend
title("t vs. H(t)")
saveas(gcf, "H(t)truth_fixed_obs.png")
...
legend
saveas(gcf, "data_single_cases_analysis/H(t)truth_obs_fixed_obs.png")
hold off
figure(2)
...
legend
hold off
saveas(gcf, "data_single_cases_analysis/H(t)truth_ensemble_and_analysis_obs_fixed_obs.png")
figure(3)
plot(t0,table2array(T2(:,"H")),"b","LineWidth",4)
title("t vs. H(t)")
hold on
...
legend
hold off
saveas(gcf, "data_single_cases_analysis/H(t)truth_and_analysis_obs_fixed_obs.png")
