T = readtable("/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/smbt11950smbtf2300smb00.3smb10.15smbf0.0sillmin415sillmax425sillslope0.01hnd2.18lnd4.44bx-0.001.csv");
...
legend
title("t vs. H(t)")
saveas(gcf, "/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/H(t)truth.png")
...
legend
saveas(gcf, "/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/H(t)truth_obs.png")
hold off
figure(2)
...
saveas(gcf, "/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/H(t)truth_and_ensemble_obs.png")
plot(t0,table2array(T(:,"aH")),"k","LineWidth",3,"DisplayName","H(t): Analysis")
legend
hold off
saveas(gcf, "/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/H(t)truth_ensemble_and_analysis_obs.png")
figure(3)
plot(t0,table2array(T(:,"H")),"r","LineWidth",3,"DisplayName","H(t): Truth")
hold on
title("t vs. H(t)")
plot(t0,table2array(T2(:,"H")),"b","LineWidth",3,"DisplayName","H(t): Differential Inital Condition")
plot(t2,table2array(OBS(:,"H")),"b","LineStyle", "none", "Marker", "o", "MarkerEdgeColor", [0 0 0],"MarkerFaceColor", [0.9290 0.6940 0.1250], "DisplayName","L(t): Observations")
xlim([0 2300])
xlabel("t")
ylim([1.5 2.5])
ylabel("H(t)")
...
legend
hold off
saveas(gcf, "/Users/loganknudsen/Documents/GitHub/StormSurge/Experiment_Data/data_single_cases_analysis/H(t)truth_and_analysis_obs.png")
