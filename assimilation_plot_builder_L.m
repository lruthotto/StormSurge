...
legend
saveas(gcf, "data_single_cases_analysis/L(t)truth_obs_fixed_obs.png")
hold off
figure(2)
...
saveas(gcf, "data_single_cases_analysis/L(t)truth_and_ensemble_obs_fixed_obs.png")
plot(t0,table2array(T(:,"aL")),"k","LineWidth",4,"DisplayName","L(t): Analysis")
legend
hold off
saveas(gcf, "data_single_cases_analysis/L(t)truth_ensemble_and_analysis_obs_fixed_obs.png")
figure(3)
plot(t0,table2array(T(:,"L")),"r","LineWidth",4)
title("t vs. L(t)")
hold on
...
legend
hold off
saveas(gcf, "data_single_cases_analysis/L(t)truth_and_analysis_obs_fixed_obs.png")
