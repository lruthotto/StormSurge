...
hold on
title("t vs. H(t)")
plot(t0,table2array(T2(:,"H")),"b","LineWidth",4,"DisplayName","H(t): Differential Inital Condition")
...
legend
hold off
%saveas(gcf, "data_single_cases_analysis/H(t)truth_and_analysis_obs.png")
